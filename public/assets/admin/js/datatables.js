...
(function($) {
    ...
    $.fn.initDataTables = function(config, options) {
        ...
        $.fn.initDataTables.defaults.url = options && options.ajaxUrl ? options.ajaxUrl : window.location.origin + window.location.pathname;
        options = $.extend(options || {}, {responsive: true});
        var root = this,
